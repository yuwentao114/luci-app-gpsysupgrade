...
function check_update()
		...
		remote_version = luci.sys.exec("echo -n $(curl -s https://github.com/yuwentao114/Actions-OpenWrt/releases/latest" ..model.. "/version.txt)")
		updatelogs = luci.sys.exec("curl -s https://github.com/yuwentao114/Actions-OpenWrt/releases/latest" ..model.. "/updatelogs.txt")
...
function to_check()
	...
	if model == "x86_64" then
		...
		if fs.access("/sys/firmware/efi") then
			download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-x86-64-generic-squashfs-combined-efi.img.gz"
		else
			download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-x86-64-generic-squashfs-combined.img.gz"
		end
    elseif model:match(".*K2P.*") then
		model = "phicomm-k2p"
		check_update()
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-ramips-mt7621-phicomm_k2p-squashfs-sysupgrade.bin"
    elseif model:match(".*AC2100.*") then
		model = "redmi-ac2100"
		check_update()
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-ramips-mt7621-redmi-ac2100-squashfs-sysupgrade.bin"
    elseif model:match(".*R2S.*") then
		model = "nanopi-r2s"
		check_update()
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-rockchip-armv8-nanopi-r2s-squashfs-sysupgrade.img.gz"
    elseif model:match(".*R4S.*") then
		model = "nanopi-r4s"
		check_update()
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-rockchip-armv8-nanopi-r4s-squashfs-sysupgrade.img.gz"
    elseif model:match(".*D2.*") then
		model = "newifi-d2"
		check_update()
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-ramips-mt7621-newifi-d2-squashfs-sysupgrade.bin"
    elseif model:match(".*XY-C5.*") then
        ...
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-ramips-mt7621-xy-c5-squashfs-sysupgrade.bin"
    elseif model:match(".*Mi Router 3 Pro.*") then
		model = "xiaomi-r3p"
		check_update()
		if remoteformat > sysverformat and currentTimeStamp > remoteformat then needs_update = true else needs_update = false end
        download_url = "https://github.com/yuwentao114/Actions-OpenWrt/releases/download/" ..model.. "/" ..dateyr.. "-openwrt-ramips-mt7621-xiaomi_mir3p-squashfs-sysupgrade.bin"
	else
